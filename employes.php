...
<head>
    ...
    <title>Gestion des Employés | SmartTec</title>
    ...
    <div class="header-container">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-md-8">
                    <h1><i class="bi bi-people me-2"></i>Gestion des Employés</h1>
                    <p class="lead">Consultez, ajoutez et modifiez les informations de vos employés</p>
                </div>
    ...
    <div class="container">
        ...
        <div class="card mb-4">
            <div class="card-header bg-primary text-white">
                <div class="row align-items-center">
                    <div class="col-md-6">
                        <h5 class="mb-0"><i class="bi bi-list-ul me-2"></i>Liste des employés</h5>
                    </div>
            ...
            <div class="card-body">
                ...
                <div class="table-responsive table-wrapper">
                    <table class="table table-hover table-striped" id="employesTable">
                        <thead class="table-light">
                            <tr>
                                ...
                                <th><i class="bi bi-briefcase me-1"></i>Poste</th>
                                <th><i class="bi bi-cash-coin me-1"></i>Salaire</th>
                                <th><i class="bi bi-calendar me-1"></i>Date d'embauche</th>
                            ...
                            <?php if (count($employes) > 0): ?>
                                ...
                                <tr>
                                    ...
                                    <td class="action-buttons">
                                        <a href="modifier_employe.php?id=<?php echo $employe['id']; ?>" class="btn btn-sm btn-warning">
                                            <i class="bi bi-pencil-square"></i> Modifier
                                        </a>
                                        <a href="employes.php?delete_id=<?php echo $employe['id']; ?>" class="btn btn-sm btn-danger" 
                                           onclick="return confirm('Êtes-vous sûr de vouloir supprimer l\'employé <?php echo $employe['nom']; ?> ?');">
                                ...
                                <tr>
                                    <td colspan="9" class="text-center py-4">
                                        <div class="alert alert-info mb-0">
                                            <i class="bi bi-info-circle me-2"></i> Aucun employé n'a été trouvé.
                                            <a href="ajouter_employe.php" class="alert-link">Ajouter un nouvel employé</a>
                                        </div>
                                    </td>
                                </tr>
                            <?php endif; ?>
                ...
                <div class="mt-3">
                    <p class="text-muted">
                        <i class="bi bi-people me-1"></i> Total : <?php echo count($employes); ?> employé(s)
                    </p>
                </div>
            </div>
        </div>
