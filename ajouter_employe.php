...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $sql = "INSERT INTO employes (nom, prenom, email, poste, salaire, date_embauche, departement) VALUES (:nom, :prenom, :email, :poste, :salaire, :date_embauche, :departement)";
...
<head>
    ...
    <title>Ajouter un Employé | SmartTec</title>
    ...
    <div class="header-container">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-md-8">
                    <h1><i class="bi bi-person-plus me-2"></i>Ajouter un Employé</h1>
                    <p class="lead">Ajoutez un nouvel employé à votre base de données</p>
                </div>
    ...
    <div class="container">
        ...
        <div class="card mb-4">
            <div class="card-header bg-primary text-white">
                <div class="row align-items-center">
                    <div class="col-md-6">
                        <h5 class="mb-0"><i class="bi bi-plus-circle me-2"></i>Ajouter un employé</h5>
                    </div>
                </div>
            </div>
            <div class="card-body">
